...
(
    ...
    # Migrate
    git clone --branch 8.x-1.x http://git.drupal.org/project/message.git
    git clone --branch 8.x-1.x http://git.drupal.org/project/message_notify.git
)
...
drush en -y commerce commerce_product commerce_order message message_notify commerce_checkout
